...
class PaymentScreenHourly extends StatefulWidget {
  const PaymentScreenHourly({super.key});

  @override
  State<PaymentScreenHourly> createState() => _PaymentScreenState();
}

class _PaymentScreenState extends State<PaymentScreenHourly> {
  ...
  displayPaymentSheet(final booking) async {
    try {
      await Stripe.instance.presentPaymentSheet().then((value) {
        ...
        Navigator.pushNamed(context, "/BookingConfirmationScreenHourly");
          ...
          child: Form(
            child: ListView(
              children: [
                ...
                const InfoRow(
                    label: "Type", value: "On Demand Hourly Pedicab Ride"),
