...
class BookingConfirmationScreenHourly extends StatefulWidget {
  const BookingConfirmationScreenHourly({super.key});

  @override
  State<BookingConfirmationScreenHourly> createState() =>
      _BookingConfirmationScreenState();
}

class _BookingConfirmationScreenState
    extends State<BookingConfirmationScreenHourly> {
          ...
          child: Form(
            child: ListView(
              children: [
                ...
                const InfoRow(
                    label: "Type",
                    value: "On Demand Hourly Pedicab Service"),
                ...
                InfoRow(label: "Date of Service", value: "${dateWithDayName} (Today)",),
                InfoRow(
                    label: "Time of Service", value: tourTimeFormatted),
                InfoRow(
